...
var _auth0_blog$elm_with_jwt_api$Main$tokenDecoder = A2(_elm_lang$core$Json_Decode$field, 'access_token', _elm_lang$core$Json_Decode$string);
var _auth0_blog$elm_with_jwt_api$Main$userEncoder = function (model) {
...
var _auth0_blog$elm_with_jwt_api$Main$authUser = F2(
	function (model, apiUrl) {
		var body = _elm_lang$http$Http$jsonBody(
			_auth0_blog$elm_with_jwt_api$Main$userEncoder(model));
		return A3(_elm_lang$http$Http$post, apiUrl, body, _auth0_blog$elm_with_jwt_api$Main$tokenDecoder);
	});
...
var _auth0_blog$elm_with_jwt_api$Main$registerUrl = A2(_elm_lang$core$Basics_ops['++'], _auth0_blog$elm_with_jwt_api$Main$api, 'users');
var _auth0_blog$elm_with_jwt_api$Main$loginUrl = A2(_elm_lang$core$Basics_ops['++'], _auth0_blog$elm_with_jwt_api$Main$api, 'sessions/create');
var _auth0_blog$elm_with_jwt_api$Main$protectedQuoteUrl = A2(_elm_lang$core$Basics_ops['++'], _auth0_blog$elm_with_jwt_api$Main$api, 'api/protected/random-quote');
var _auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuote = function (model) {
	return _elm_lang$http$Http$request(
		{
			method: 'GET',
			headers: {
			...
			url: _auth0_blog$elm_with_jwt_api$Main$protectedQuoteUrl,
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectString,
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
...
var _auth0_blog$elm_with_jwt_api$Main$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
...
var _auth0_blog$elm_with_jwt_api$Main$setStorageHelper = function (model) {
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _auth0_blog$elm_with_jwt_api$Main$setStorage(model)
	};
};
var _auth0_blog$elm_with_jwt_api$Main$fetchRandomQuoteCompleted = F2(
	function (model, result) {
		var _p0 = result;
		if (_p0.ctor === 'Ok') {
			return _auth0_blog$elm_with_jwt_api$Main$setStorageHelper(
...
var _auth0_blog$elm_with_jwt_api$Main$getTokenCompleted = F2(
	function (model, result) {
		var _p1 = result;
		if (_p1.ctor === 'Ok') {
			return _auth0_blog$elm_with_jwt_api$Main$setStorageHelper(
...
var _auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuoteCompleted = F2(
	function (model, result) {
		var _p2 = result;
		if (_p2.ctor === 'Ok') {
			return _auth0_blog$elm_with_jwt_api$Main$setStorageHelper(
...
var _auth0_blog$elm_with_jwt_api$Main$removeStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'removeStorage',
	function (v) {
		return {username: v.username, password: v.password, token: v.token, quote: v.quote, protectedQuote: v.protectedQuote, errorMsg: v.errorMsg};
	});
var _auth0_blog$elm_with_jwt_api$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {username: a, password: b, token: c, quote: d, protectedQuote: e, errorMsg: f};
	});
var _auth0_blog$elm_with_jwt_api$Main$LogOut = {ctor: 'LogOut'};
var _auth0_blog$elm_with_jwt_api$Main$FetchProtectedQuoteCompleted = function (a) {
	return {ctor: 'FetchProtectedQuoteCompleted', _0: a};
};
var _auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuoteCmd = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_auth0_blog$elm_with_jwt_api$Main$FetchProtectedQuoteCompleted,
		_auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuote(model));
};
var _auth0_blog$elm_with_jwt_api$Main$GetProtectedQuote = {ctor: 'GetProtectedQuote'};
var _auth0_blog$elm_with_jwt_api$Main$GetTokenCompleted = function (a) {
	return {ctor: 'GetTokenCompleted', _0: a};
};
var _auth0_blog$elm_with_jwt_api$Main$authUserCmd = F2(
	function (model, apiUrl) {
		return A2(
			_elm_lang$http$Http$send,
			_auth0_blog$elm_with_jwt_api$Main$GetTokenCompleted,
			A2(_auth0_blog$elm_with_jwt_api$Main$authUser, model, apiUrl));
	});
var _auth0_blog$elm_with_jwt_api$Main$ClickLogIn = {ctor: 'ClickLogIn'};
var _auth0_blog$elm_with_jwt_api$Main$ClickRegisterUser = {ctor: 'ClickRegisterUser'};
var _auth0_blog$elm_with_jwt_api$Main$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _auth0_blog$elm_with_jwt_api$Main$SetUsername = function (a) {
...
var _auth0_blog$elm_with_jwt_api$Main$init = function (model) {
	var _p3 = model;
	if (_p3.ctor === 'Just') {
		return {ctor: '_Tuple2', _0: _p3._0, _1: _auth0_blog$elm_with_jwt_api$Main$fetchRandomQuoteCmd};
	} else {
		return {
			ctor: '_Tuple2',
			_0: A6(_auth0_blog$elm_with_jwt_api$Main$Model, '', '', '', '', '', ''),
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'FetchRandomQuoteCompleted':
				return A2(_auth0_blog$elm_with_jwt_api$Main$fetchRandomQuoteCompleted, model, _p4._0);
			case 'SetUsername':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'ClickRegisterUser':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_auth0_blog$elm_with_jwt_api$Main$authUserCmd, model, _auth0_blog$elm_with_jwt_api$Main$registerUrl)
				};
			case 'ClickLogIn':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_auth0_blog$elm_with_jwt_api$Main$authUserCmd, model, _auth0_blog$elm_with_jwt_api$Main$loginUrl)
				};
			case 'GetTokenCompleted':
				return A2(_auth0_blog$elm_with_jwt_api$Main$getTokenCompleted, model, _p4._0);
			case 'GetProtectedQuote':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuoteCmd(model)
				};
			case 'FetchProtectedQuoteCompleted':
				return A2(_auth0_blog$elm_with_jwt_api$Main$fetchProtectedQuoteCompleted, model, _p4._0);
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
					...
					_1: _auth0_blog$elm_with_jwt_api$Main$removeStorage(model)
				};
		}
	});
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_auth0_blog$elm_with_jwt_api$Main$LogOut),
											_1: {ctor: '[]'}
										}
									},
									{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(_auth0_blog$elm_with_jwt_api$Main$SetUsername),
																		_1: {ctor: '[]'}
																	}
																}
															}
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_auth0_blog$elm_with_jwt_api$Main$SetPassword),
																			_1: {ctor: '[]'}
																		}
																	}
																}
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_auth0_blog$elm_with_jwt_api$Main$ClickLogIn),
														_1: {ctor: '[]'}
													}
												},
												{
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_auth0_blog$elm_with_jwt_api$Main$ClickRegisterUser),
															_1: {ctor: '[]'}
														}
													},
													{
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_auth0_blog$elm_with_jwt_api$Main$GetProtectedQuote),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _auth0_blog$elm_with_jwt_api$Main$main = _elm_lang$html$Html$programWithFlags(
	{
